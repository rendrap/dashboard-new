    ...
    324: function(t, e, n) {
        ...
        var l = {
            ...
            _updateInlineStyle: function() {
                ...
                var n = s.replace(/\{navbarHeight\}/gi, t).replace(/\{footerHeight\}/gi, e);
            ...
            setCollapsed: function() {
                var t = this,
                    e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : r("collapsed"),
            ...
            setPosition: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : r("fixed"),
                    e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : r("offcanvas");
            ...
            setReversed: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : r("reversed");
            ...
            setAutoUpdate: function() {
                var t = this,
                    e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : r("enable");
            ...
            on: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : r("event"),
                    e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : r("callback"),
                    n = t.split("."),
                    o = i(n),
                    a = o[0],
                    s = o.slice(1);
            ...
            off: function() {
                var t = this,
                    e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : r("event"),
                    n = e.split("."),
                    o = i(n),
                    a = o[0],
                    s = o.slice(1);
